...
# 配置
input_folder = r'E:\YHH\Cryo-floods\webgis_backend\static\runoff_results'  # 存放每日测t预if的文件夹
output_file = r'E:\YHH\Cryo-floods\data\raw\thresholds\grid_threshold_99p.tif'  # 输出阈值栅格路径
percentile = 99  # 目标百分位，99%
